...
window.keyshotXR = function(X, w, G, Y, va, D, wa, xa, ya, za, Aa, K, L, Z, $, Ba, aa, Ca, ba, Da, ca, Ea, Fa, Ga, Ha, r, Ia) {
    ...
    function k(a, d, b) {
        a.addEventListener ? a.addEventListener(d, b, u) : a.attachEvent && (a["e" + d + b] = b, a.attachEvent("on" + d,
        function() {
            a["e" + d + b]()
        }))
    }
    ...
    function I(f) {
        ...
        f.preventDefault ? f.preventDefault() : f.returnValue = u;
        0 < j.d && (1 == j.d ? pa(f.pageX, f.pageY) : 2 == j.d ? (f = a.cursor.y - E.start.y, d = a.w(), a.T(c.u * Math.exp(f / 200)), f = a.w(), c.j += parseFloat(a.e * d - a.e * f), c.k += parseFloat(a.f * d - a.f * f)) : 3 == j.d && (d = a.cursor.x - E.start.x, f = a.cursor.y - E.start.y, c.j += parseFloat((d - c.m.x) / c.g), c.k += parseFloat((f - c.m.y) / c.g), c.m.x = d, c.m.y = f))
    }
    function O(f) {
        f || (f = window.event);
        var d = 0;
    ...
    function la(f) {
        ...
        if (1 == d.length && d[0]) if (j.start.x = d[0].pageX, j.start.y = d[0].pageY, j.a.x = d[0].pageX, j.a.y = d[0].pageY, a.qa = d[0].target, a.qa == a.r) j.d = 1,
        oa(d[0].pageX, d[0].pageY);
        else for (var e = a.qa; e && e != a.r;) {
    ...
    function U() {
        Ka(U);
        a.W == a.Z && (1 == j.d ? 0.01 < i.L ? (i.b.x = 0.4 * (l.a.x - i.a.x), i.b.y = 0.4 * (l.a.y - i.a.y), i.a.x += i.b.x, i.a.y += i.b.y, a.na(i.b.x, i.b.y)) : (a.na(l.b.x, l.b.y), l.b.x = 0, l.b.y = 0) : 0.01 < i.L && (i.b.x *= i.L, i.b.y *= i.L, 0.055 > i.b.x * i.b.x + i.b.y * i.b.y && (i.b.x = 0, i.b.y = 0, l.b.x = 0, l.b.y = 0, l.a.x = i.a.x, l.a.y = i.a.y), (0 != i.b.x || 0 != i.b.y) && a.na(i.b.x, i.b.y)));
        a.Ca();
        var f = 0;
        if ( - 1 == a.ha) {
            for (var b = 1,
    ...
    this.Ca = function() {
        if (e.J) {
            ...
            if ( - 1 != a.F[b] && (W.setAttribute("src", a.D[b]), W.complete || (a.ja = p), void 0 !== r)) if (b = a.ia[b], !b && void 0 == r[b]) {
            ...
            d.innerHTML = r[b].text,
            d.id = "xr_hotspot",
            d.style.position = "absolute",
            d.style.left = r[b].position.x + "px",
            d.style.top = r[b].position.y + "px",
            d.style.color = "#000000",
            void 0 !== r[b].options && (r[b].options.fontSize && (d.style.fontSize = r[b].options.fontSize), r[b].options.Ia && (d.style.color = r[b].options.Ia), r[b].options.bgColor && (d.style.backgroundColor = r[b].options.bgColor), r[b].options.link && (d.href = r[b].options.link), r[b].options.height && (d.style.height = r[b].options.height), r[b].options.width && (d.style.width = r[b].options.width), r[b].options.textAlign && (d.style.textAlign = r[b].options.textAlign)),
            document.body.appendChild(d)
        }
        if (c.n != c.a || c.j != c.xa || c.k != c.ya) c.a = c.n,
        c.xa = c.j,
        c.ya = c.k,
        na()
    };
        ...
        h = parseFloat(e.c / c), g = parseFloat(e.i / c), i = e.q, j = 0, k = 0, m = 0, n = 0, l = 0; a.P < i;) {
            ...
            k = 0;
                ...
                if (1 > h && 1 > g) {
                    ...
                    c = parseInt(b / e.c),
                    l = parseInt(c * e.c + d),
                    a.D[l] || (a.C[a.P] = l, a.P++, a.D[l] = a.va(d, c), void 0 !== r && r[c + "_" + d] && (a.ia[l] = c + "_" + d));
                    break
                }
                j = m = k = 0
            }
    ...
    var Ka = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame ||
    function(a) {
    ...
    if (document.createElement("canvas").getContext) {
        ...
        a.r.appendChild(a.S));
        if (a.W) { / Android | webOS | iPhone | iPad | iPod | BlackBerry | IEMobile | Opera Mini / i.test(navigator.userAgent) && (J = p);
            ...
            J ? a.X.setAttribute("src", A + a.s + "/files/xr_hand.gif") : a.X.setAttribute("src", A + a.s + "/files/xr_cursor.gif");
